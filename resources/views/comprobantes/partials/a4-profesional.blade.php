...
<head>
    ...
    <style>
        @page{margin:34px 42px 70px}*{box-sizing:border-box}body{margin:0;font-family:DejaVu Sans,sans-serif;font-size:9.5px;color:#111827}table{width:100%;border-collapse:collapse}.header td{vertical-align:middle}.business{width:65%}.logo-cell{width:115px;text-align:center}.logo-cell img{max-width:105px;max-height:74px}.business-data{padding-left:14px;line-height:1.55}.business-name{color:#092a59;font-size:21px;font-weight:bold}.slogan{margin-bottom:3px;color:#6b7280;font-size:8.5px}.document-box{width:35%;padding:18px 12px;border:2px solid #174b8d;text-align:center}.document-title{color:#174b8d;font-size:15px;font-weight:bold;line-height:1.35}.document-number{margin-top:14px;font-size:16px;font-weight:bold}.blue-rule{margin:17px 0;border-top:2px solid #174b8d}.client-box{padding:9px 5px 10px;background:#f1f5f9}.section-title{margin-bottom:7px;color:#174b8d;font-size:11px;font-weight:bold}.client-box td{padding:3px 0;vertical-align:top}.client-label{width:14%}.client-value{width:50%;font-weight:bold}.sale-label{width:13%}.sale-value{width:23%;text-align:right}.items{margin-top:10px;table-layout:fixed}.items th{padding:7px 4px;background:#174b8d;color:#fff;font-size:8.5px}.items td{padding:7px 5px;border:1px solid #cbd5e1;vertical-align:middle}.center{text-align:center}.right{text-align:right}.additional{margin-top:12px}.additional-value{min-height:24px;padding:5px 7px;border:1px solid #cbd5e1}.summary{margin-top:18px}.words-cell{width:58%;padding-right:35px;vertical-align:top}.words{padding:6px;border:1px solid #cbd5e1;text-align:center;font-weight:bold}.payment{margin-top:11px;line-height:1.6}.totals-cell{width:42%;vertical-align:top}.totals td{padding:5px 6px}.total-row td{padding:8px 6px;background:#174b8d;color:#fff;font-size:13px;font-weight:bold}.bottom{margin-top:22px;page-break-inside:avoid}.qr-cell{width:28%;text-align:center;vertical-align:top}.qr-cell img{width:100px;height:100px}.qr-caption{color:#174b8d;font-size:7px;font-weight:bold}.legal-cell{width:72%;padding:17px 15px 0;color:#475569;font-size:8px;line-height:1.5;vertical-align:top}.footer{position:fixed;right:0;bottom:-48px;left:0;padding-top:9px;border-top:1px solid #174b8d;color:#4b5563;text-align:center;font-size:7.5px}
    </style>
</head>
<body>
@php
    $currency=$config->moneda?:'S/';
...
<table class="header"><tr>
    ...
    <td class="document-box"><div class="document-title">{{ $documentTitle }}</div><div class="document-number">{{ $venta->serie }}-{{ str_pad($venta->correlativo,8,'0',STR_PAD_LEFT) }}</div></td>
</tr></table>
...
<div class="footer">Representación impresa del comprobante. Gracias por su compra.</div>
</body></html>
