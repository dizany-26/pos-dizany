...
<div class="modal fade" id="modalNuevoUsuario" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl usuario-modal-dialog">
        <form method="POST" action="{{ route('usuarios.store') }}" class="modal-content usuario-modal-form" id="formNuevoUsuario" autocomplete="off" data-roles-usuarios="{{ $roles->pluck('id', 'nombre')->toJson() }}">
            @csrf
