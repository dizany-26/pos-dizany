            ...
            <div class="modal-body">
                <form id="clientForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-soft btn-soft-info" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" class="btn btn-soft btn-soft-primary">Registrar Cliente</button>
                    </div>
                </form>
            </div>
        </div>
