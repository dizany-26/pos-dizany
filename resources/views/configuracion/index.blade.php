...
<div class="card ui-card container-card my-4 mx-auto" style="max-width: 1000px;">
    ...
    <div class="card-body px-4 pb-4">
        <nav class="config-subpages" aria-label="Secciones de configuración">
            <a href="{{ route('configuracion.index') }}" class="active"><i class="fas fa-building"></i><span>Datos generales</span></a>
            <a href="{{ route('configuracion.appearance') }}"><i class="fas fa-palette"></i><span>Apariencia</span></a>
        </nav>
