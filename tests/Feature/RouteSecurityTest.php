...
class RouteSecurityTest extends TestCase
{
    public function test_sensitive_routes_require_authentication_and_authorization(): void
    {
        $expectedMiddleware = [
            ...
            'gastos.store' => ['auth', 'permission:ventas,gastos'],
            ...
            'reportes.index' => ['auth', 'permission:reportes'],
            'reportes.resumen' => ['auth', 'permission:reportes'],
            'reportes.exportar' => ['auth', 'permission:reportes'],
